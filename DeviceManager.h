...
public:
    ...
    static std::string deviceTypeString(DeviceType deviceType) //获得设备类型字符串（设备类型）
    {
        switch (deviceType)
        {
        case DeviceType::all:
    ...
    static std::string deviceStateTypeString(DeviceStateType deviceStateType) //获得设备状态字符串（设备状态）
    {
